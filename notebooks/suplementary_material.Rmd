...
```
Each parameters can be identified separately, now of course identifying them all togethre is another matter, there might exists several combinations of parameter that yield the same pure premium. Our optimization allows us to investigate by searching efficiently the parameter space. 
...
Even if the model is misspecified it looks like we get a unique minimum in each dimension
